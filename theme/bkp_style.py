...
def get_item_row_even_style():
    """Get style for even-numbered item rows"""
    return f"""
        QFrame {{
            background: {WHITE};
            border: 1px solid {BORDER};
...
def get_item_row_odd_style():
    """Get style for odd-numbered item rows"""
    return f"""
        QFrame {{
            background: #F9FAFB;
            border: 1px solid {BORDER};
...
def get_item_row_error_style():
    """Get style for item row with validation error"""
    return f"""
        QFrame {{
            background: #FEF2F2;
            border: 2px solid {DANGER};
...
def get_action_icon_button_style(color: str = None):
    """Get style for small action icon buttons"""
    ...
    return f"""
        ...
        QPushButton:hover {{
            opacity: 0.9;
            background: {PRIMARY_HOVER if bg_color == SUCCESS else '#DC2626'};
        }}
    """
